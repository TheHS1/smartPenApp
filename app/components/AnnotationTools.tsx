...
export default function AnnotationTools({ showAnnotation, strokeSize, erase, color, clearPath, redoDraw, setErase, setStroke, toggleShowAnnotation, toggleShowPicker, undoDraw }: toolProps) {
  return (
