...
export default function Annotations({ saveDocument, paths, setPaths }: annotationProps) {
  enum actions {
    addPath,
    deletePath,
    clear
    ...
    <View className="flex-1 flex border-blue-500 border-4 w-full h-full">
      ...
      <GestureHandlerRootView>
        <GestureDetector gesture={composed}>
          <Canvas style={{ flex: 1 }} className="absolute">
